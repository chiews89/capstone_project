...
def seed_likes():
    ...
    like3 = Like(user_id=3, post_id=12)
    like4 = Like(user_id=4, post_id=12)
    like5 = Like(user_id=5, post_id=12)
    like6 = Like(user_id=6, post_id=12)
    like7 = Like(user_id=7, post_id=12)
    like8 = Like(user_id=8, post_id=12)
    like9 = Like(user_id=1, post_id=12)
